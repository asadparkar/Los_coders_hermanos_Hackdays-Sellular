...
const Event = ({ename,eimg,status,organizer,theme,description,mode,timeline,prize,applicants,id}) => {
...
>
  <Stack w='100%' display='flex'>
    ...
    <Stack style={{display:'flex'}} flexDirection={{md:'row', sm:'column'}} alignItems='center'>
      <Heading fontSize={{md:'2xl', sm:'md'}} fontFamily='Poppins'>{ename}</Heading>
    ...
    <CardFooter>
      ...
      <Text color={'gray.600'}>Posted by <span style={{fontWeight:'bold'}}>{organizer}</span></Text>
